...
/* Set to true to enable dump in the server logs */
...
if (enableDumping) {
    ...
    */
    ...
    // TODO: some needs to be removed from here and put on another more dedicated blockId!
    // prettier-ignore
    const foliage = [
    ...
    */
    ...
    console.log(
        "Dumping for Complementary Shader disabled! Set 'enableDumping = true' in complementary_block_dump.js to enable!"
    );
}
